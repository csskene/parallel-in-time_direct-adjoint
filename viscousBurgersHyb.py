...
if __name__ == '__main__':
    ...
    Print('Running the viscous Burgers (hybrid) example')
    # Setup the problem ##
    n = 128
    dx = 2*np.pi/n
    ...
    # κ for the time partition
    κ = 1
    solCtx = pe.paraExpIntegrator(T,hompartDir, nonlinPart,hompartAdj,costIntegrand,costIntegranddq,equationdf,inhomPart,n,κ)
